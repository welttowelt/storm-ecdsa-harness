...
- fail: existing counterexample ledger hit, all current unknowns already closed,
  stale source, wrong q-tier, local-heavy context, compute request, premature
  Akash/submit language, overclaimed evidence label, missing no-submit ACK, or
  nonnegative expected delta.
